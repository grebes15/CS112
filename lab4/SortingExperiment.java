...
public class SortingExperiment
{
  ...
  private static int EXPERIMENT_SIZE = 100;
  ...
  public static void main(String[] args)
  {
    ...
    //I was able to make the command line by the changing that instead of having the parameter be set to the EXPERIMENT_SIZE, I changed it to Integer.parseInt so I was able to set an integer into the terminal and it would successfully run
    experimentBubbleSort(Integer.parseInt(args[0]));
    experimentSelectionSort(Integer.parseInt(args[0]));
    experimentInsertionSort(Integer.parseInt(args[0]));
    experimentMergeSort(Integer.parseInt(args[0]));
    experimentQuickSort(Integer.parseInt(args[0]));
