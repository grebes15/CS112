...
public class ArrayIndexList<E> implements IndexList<E> {
  ...
  private int capacity = 4;  // initial length of array A
...
//begin#fragment vector list
  ...
  public void add(int r, E e) 
    ...
    if (size == capacity) {		// an overflow
      capacity *= 2;
      E[] B =(E[]) new Object[capacity]; //allocate
...
//end#fragment vector
  ...
  /** Demonstrate the functionality of the ArrayIndexList */
  public static void main(String[] args){
      ArrayIndexList<String> list = new ArrayIndexList<String>();
      
      // add in a data value and then retrieve it from the list
      list.add(0, new String("CMPSC 112"));
      System.out.println("The element: " + list.get(0));
      
      // remove the data value and then show exception handling works
      //list.remove(0);
      System.out.println("The element: " + list.get(0));
	for(int i = 0; i <= 150; i++){
	list.add(i,"i");
	System.out.println("Lets see if this works: " + i);
	}
  }
